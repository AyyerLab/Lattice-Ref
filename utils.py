...
def makedata_config(config_file):
    ...
    return N, NUM_SAMPLES, SHAPE, SCALE, SHIFTS, SEED, DATA_FILE, ADD_NOISE, NOISE_MU, NOISE_K
...
def run_config(config_file):
    ...
    return N, NUM_ITER, INIT_FTOBJ, DATA_FILE, OUTPUT_FILE, PIXELS, USE_SHRINKWRAP
